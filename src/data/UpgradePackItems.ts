...
export const UPGRADE_PACK_POOL: UpgradePackItem[] = [
  ...
  // ── 트리플 강화 — 신규 카드 (rare) ───────────────────────────────────────────
  { id: 'triple-wax',             theme: 'upgrade', title: '밀랍 트리플',     effect: '★ 굳음 +1턴 추가',          rarity: 'rare', weight: 10 },
  ...
  { id: 'triple-chandelier',      theme: 'upgrade', title: '샹들리에 트리플', effect: '★ 피해 +1 추가',            rarity: 'rare', weight: 10 },
  { id: 'triple-fire-arrow',      theme: 'upgrade', title: '불화살 트리플',   effect: '★ 최대 피해 +5 추가',       rarity: 'rare', weight: 10 },
  { id: 'triple-book-of-flames',  theme: 'upgrade', title: '화염의 서 트리플',effect: '★ 피해 +1 추가',            rarity: 'rare', weight: 10 },
  { id: 'triple-shield-bash',     theme: 'upgrade', title: '방패 밀치기 트리플',effect:'★ 배율 +1 추가 (방패×4)',   rarity: 'rare', weight: 10 },
  { id: 'triple-teapot',          theme: 'upgrade', title: '주전자 트리플',   effect: '★ 기본 피해 +2 추가',       rarity: 'rare', weight: 10 },
