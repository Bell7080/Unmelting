/**
 * 380차원 에나 정책을 재학습하고, 괴물꽃 3축을 가린 구 관측 한계와 동일 망을 비교한다.
...
const report = `# Ena 380 사전학습 및 시뮬레이션 근사 감사

## 재현 설정

- 관측: 380 / 행동: 27 / hidden: ${TRAIN_CONFIG.hidden}
...
|---|---:|---:|---:|---:|---:|
| 380 전체 관측 | ${full.averageTurns.toFixed(2)} | ${pct(full.monsterPriorityRate)} | ${full.monsterDefeated}/${full.monsterSpawned} | ${full.monsterSurvivalP50} | ${full.monsterSurvivalP90} |
