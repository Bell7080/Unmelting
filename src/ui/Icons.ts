...
/** 경험(성향) — 사각 보석 대신 둥근 촛불 불빛으로 경험 탭의 안팎 아이콘을 통일한다. */
export function experienceIcon(): string {
  return svg(
    [
      // 바깥 불꽃은 완만한 곡선으로 눌러 성향 패널의 부드러운 불빛 표식으로 읽히게 한다.
      fill('M12 2.8 C 13.2 5.7 17.2 7.4 17.2 12.1 C 17.2 16.2 14.8 19.2 12 20.9 C 9.2 19.2 6.8 16.2 6.8 12.1 C 6.8 8.7 9.2 6.7 12 2.8 Z'),
      // 안쪽 심지는 밝은 핵만 남겨 작은 크기에서도 불빛 아이콘처럼 보이게 한다.
      stroke('M12 7.3 C 11.1 9.1 9.9 10.3 9.9 12.7 C 9.9 14.5 10.8 15.8 12 16.6 C 13.2 15.8 14.1 14.5 14.1 12.7 C 14.1 10.3 12.9 9.1 12 7.3 Z', 1.05),
      stroke('M8.8 19.2 C 10.6 20.5 13.4 20.5 15.2 19.2', 1.05),
    ].join(''),
  )
}
