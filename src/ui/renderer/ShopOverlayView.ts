        ...
        <div class="shop-relic-flipper">
          <div class="shop-relic-front">
            ...
            <div class="shop-relic-body">
              ...
              <p class="shop-relic-effect">${this.host.faces.resourceIconTextHtml(description)}</p>
          ...
          <div class="shop-pack-pick-flipper">
            ...
            <div class="shop-pack-pick-front">
              ...
              <div class="shop-pack-pick-body">
                ...
                <p class="shop-pack-pick-card-effect">${this.host.faces.resourceIconTextHtml(item.effect)}</p>
                ${recipeNoteLine}
              </div>
            </div>
          </div>
                  ...
                  <div class="shop-relic-flipper">
                    <div class="shop-relic-front shop-trial-front">
                      ...
                      <div class="shop-relic-body shop-trial-body">
                        ...
                        <p class="shop-relic-effect shop-trial-effect">${this.host.faces.resourceIconTextHtml(card.effect)}</p>
                      </div>
                    </div>
                  </div>
                </button>
